...
from envs import env_humanoid_obj_imitation_interaction_graph as my_env
...
class HumanoidObjImitationInteractionGraphTwo(MultiAgentEnv):
...
env_cls = HumanoidObjImitationInteractionGraphTwo
