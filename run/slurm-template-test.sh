...
#SBATCH --output=/checkpoint/%u/jobs/${JOB_NAME}.out
#SBATCH --error=/checkpoint/%u/jobs/${JOB_NAME}.err
...
tmp_dir=/checkpoint/jungdam/tmp/
port=15206
ip_head=$ip:$port
export ip_head
...
echo "STARTING HEAD at $node_1 / $iname"
